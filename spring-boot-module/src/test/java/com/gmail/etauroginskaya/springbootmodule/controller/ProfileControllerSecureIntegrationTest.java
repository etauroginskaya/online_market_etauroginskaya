...
public class ProfileControllerSecureIntegrationTest {
    ...
    @Test
    public void shouldSucceedForProfilePage() throws Exception {
    ...
    @WithMockUser(authorities = {CUSTOMER_ROLE_NAME})
    @Test
    public void shouldSucceedForUpdateProfile() throws Exception {
        mvc.perform(post(PROFILE_URL))
                .andExpect(status().isOk());
    }
}
